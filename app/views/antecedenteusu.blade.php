...
<legend><h3><p class="text-center">Antecedentes del paciente</p></h3></legend>
...
$(document).ready(
    function () {
 $('select#antecedente').change(function(){
        var municnacId = $("#antecedente").val();
        var url="/public/tipoante/"+municnacId;
