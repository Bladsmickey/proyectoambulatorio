...
<ul class="nav nav-pills">
  <li class="active"><a href="#paciente" data-toggle="tab">1. Paciente</a></li>
</ul>
<br><br>
   {{ Form::open(array('url' => 'nuevo/paciente', 'class'=>'form-horizontal')) }}
...
<div class="form-group">
        ...
        <div class="col-md-4">{{ Form::text('nombres', Input::old('nombres'),array('class' => 'form-control','pattern'=>'[a-zA-Z ]+','title'=>'Solo se permiten letras','required'=>'required')) }}</div>

        <label class="col-md-2">Apellidos</label>

        <div class="col-md-4">{{ Form::text('apellidos', Input::old('apellidos'),array('class' => 'form-control','pattern'=>'[a-zA-Z ]+','title'=>'Solo se permiten letras','required'=>'required')) }}</div>
</div>
...
<div class="form-group">
    	...
    	<div class="col-md-3">
  {{ Form::text('cedula', Input::old('cedula'),array('class' => 'form-control','pattern'=>'[0-9]+','title'=>'Solo numeros y no espacios','required'=>'required')) }}
   		 </div>
...
<div class="form-group">
	...
	<div class="col-md-2">{{ Form::text('nacionalidad', Input::old('nacionalidad'),array('class' => 'form-control','pattern'=>'[a-zA-Z ]+','title'=>'Solo se permiten letras','required'=>'required'))}}
    </div>
	...
	<div class="col-md-4"><input type="date" class="form-control" name="fechanac" id="fechanac" required="required">
    </div>
...
<div class="col-md-10">
      <select name="sexo" id="sexo" class="form-control"><option value="Femenino">Femenino</option>
    <option value="Masculino">Masculino</option></select></div></div>



<legend>2. Datos de nacimiento</legend>

<div class="form-group">

        <label class="col-md-2">Pais de nacimiento</label>
        <div class="col-md-8">
        {{ Form::text('paisnac', Input::old('paisnac'),array('class' => 'form-control','pattern'=>'[a-zA-Z ]+','title'=>'Solo se permiten letras','required'=>'required'))}}
    	</div>
...
<div class="form-group">
   		...
   		<label class="col-md-2">Estado Nacimiento</label><div class="col-md-2">

     <select name="estnac" id="estnac" class="form-control">
...
@endforeach
        ...
        <label class="col-md-2">Municipio nacimiento</label><div class="col-md-2">


  <select name="municnac" id="municnac" class="form-control">
<option selected="selected">--Seleccionar municipio--</option>
  </select>
  </div>


        <label class="col-md-2">Ciudad nacimiento</label><div class="col-md-2">

  <select name="ciudadnac" id="ciudadnac" class="form-control">
...
<legend>3. Datos situacionales</legend>
...
<div class="form-group">
        ...
        <div class="col-md-10">
        {{ Form::text('ocupacion', Input::old('ocupacion'),array('class' => 'form-control','pattern'=>'[a-zA-Z ]+','title'=>'Solo se permiten letras','required'=>'required'))}}</div>
</div>

<legend>4. Datos de residencia actual</legend>
...
<div class="form-group">
		...
		<div class="col-md-3">
        {{ Form::text('piso', Input::old('piso'),array('class' => 'form-control'))}}</div>
...
<div class="col-md-12 text-center">
  ...
  {{ Form::submit('Enviar',array('class'=>'btn btn-success')) }}</div>
    </div>
...
$('#fechanac').on('change paste keyup', function(){
